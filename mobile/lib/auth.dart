      ...
      body: Stack(
        children: <Widget>[
          Pinned.fromPins(
            ...
            Pin(size: 83.0, middle: 0.2791),
            child:
                // Adobe XD layer: 'Logo extra' (group)
                Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(start: 38.0, end: 48.0),
          ...
          Pinned.fromPins(
            ...
            child:
                // Adobe XD layer: 'Create account btn' (group)
                PageLink(
              links: [
                PageLinkInfo(
                  transition: LinkTransition.Fade,
          ...
          Pinned.fromPins(
            ...
            child:
                // Adobe XD layer: 'About icon' (shape)
                SvgPicture.string(
              _svg_e7b2h1,
